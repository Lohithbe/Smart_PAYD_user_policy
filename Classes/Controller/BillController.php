...
class BillController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * billRepository
     *
     * @var \SmartPAYD\UserPolicy\Domain\Repository\BillRepository
     * @inject
     */
    ...
    {
        // $policies = $this->policyRepository->fetchPolicyID($newBill->getPolicyName());
        //foreach ($policies as $indx => $pol) {
        //  $newBill->setPolicyID($pol->getUid());
        //  }
