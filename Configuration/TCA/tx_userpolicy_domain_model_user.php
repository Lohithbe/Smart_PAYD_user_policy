...
return [
    'ctrl' => [
        ...
        'searchFields' => 'full_name,user_i_d,start_date,end_date,policy_i_d,vehicle_i_d,bill_i_d,vehicle,bill',
        'iconfile' => 'EXT:user_policy/Resources/Public/Icons/tx_userpolicy_domain_model_user.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, full_name, user_i_d, start_date, end_date, policy_i_d, vehicle_i_d, bill_i_d, vehicle, bill',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, full_name, user_i_d, start_date, end_date, policy_i_d, vehicle_i_d, bill_i_d, vehicle, bill, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'policy_i_d' => [
            'exclude' => true,
            'label' => 'LLL:EXT:user_policy/Resources/Private/Language/locallang_db.xlf:tx_userpolicy_domain_model_user.policy_i_d',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'vehicle_i_d' => [
            'exclude' => true,
            'label' => 'LLL:EXT:user_policy/Resources/Private/Language/locallang_db.xlf:tx_userpolicy_domain_model_user.vehicle_i_d',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'bill_i_d' => [
            'exclude' => true,
            'label' => 'LLL:EXT:user_policy/Resources/Private/Language/locallang_db.xlf:tx_userpolicy_domain_model_user.bill_i_d',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
